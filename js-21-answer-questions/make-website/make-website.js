/*
We want you to build a website. Until now you have learned all the basics needed for building a full and functional website via javascript. For this assignment you will have 2 weeks time.
...
Your login page should include validation for the user's credentials. If the entered credentials are correct, the user should be redirected to the home page. If the credentials are incorrect, an error message should be displayed to inform the user of their invalid credentials.
*/
